...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: '正在加载 Verxio 设置',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '你的 Verxio 后端早于当前桌面构建，可能无法正常工作。请更新以保持一致。',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面后端拒绝了该请求 (405 Method Not Allowed)。请尝试重启 Verxio。',
  ...
  settings: {
    ...
    resetConfirm: '将所有设置恢复为 Verxio 默认值？',
    exportFailed: '导出失败',
    resetFailed: '重置失败',
    nav: {
      providers: '提供方',
    ...
    socials: {
      title: '社交',
      intro: '通过自托管 Postiz 安排并发布社交内容。可连接多个账号，打开日历，并让智能体起草与排期。',
      loading: '正在加载社交…',
      failedLoad: '无法加载社交状态。',
      ready: '就绪',
      needsKey: '需要设置',
      disabled: '未启用',
      unavailable: '不可用',
      notConfigured: '此部署未运行 Postiz。请先启动 Postiz 栈，再启用社交。',
      setupTitle: '此工作区的 Postiz',
      enabledDescription: '社交排期已启用。连接渠道或打开日历管理帖子。',
      disabledDescription: '启用社交以为此工作区开通免费 Postiz 排期。',
      enable: '启用社交',
      disable: '禁用',
      disableConfirm: '禁用此工作区的社交？已连接渠道仍保留在 Postiz，直到你移除它们。',
      enableFailed: '无法启用社交。',
      disableFailed: '无法禁用社交。',
      enabledTitle: '社交已启用',
      enabledMessage: '此工作区可通过 Postiz 排期发帖。',
      disabledTitle: '社交已禁用',
      disabledMessage: '已从此智能体运行时移除 Postiz 工具。',
      openCalendar: '打开日历',
      calendarTitle: '内容日历',
      calendarDescription: '查看并编辑已排期帖子。若此处无法加载，请在新窗口打开。',
      calendarFailed: '无法打开日历。',
      openInNewWindow: '在新窗口打开',
      connectChannel: '连接渠道',
      connectTitle: '连接社交账号',
      connectDescription: '选择网络。可连接多个账号；每次都会打开 Postiz OAuth。',
      connectFailed: '无法开始连接渠道。',
      connectOpenedTitle: '请在 Postiz 中继续',
      connectOpenedMessage: '在打开的窗口中完成账号连接，然后返回此处。',
      channelsTitle: '已连接渠道',
      noChannelsTitle: '暂无渠道',
      noChannels: '连接 LinkedIn、X、Instagram 等。可添加多个账号。',
      disconnect: '断开',
      disconnectConfirm: '从此 Postiz 断开该渠道？',
      disconnectFailed: '无法断开渠道。',
      disconnectedTitle: '渠道已断开',
      disconnectedMessage: '该账号已从此工作区日历移除。',
      channelActive: '活跃',
      channelDisabled: '已禁用',
      postsTitle: '即将发布',
      noPostsTitle: '暂无排期帖子',
      noPosts: '在日历中起草或排期帖子后，它们会显示在这里。',
      unscheduledPost: '未排期',
      draftPost: '草稿'
    },
    runtime: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: '当 Verxio 需要本地时间上下文时使用。留空则使用系统时区。',
      agent: {
        imageInputMode: '控制图片附件如何发送给模型。',
        maxTurns: 'Verxio 停止一次运行前工具调用轮次的上限。'
      },
      terminal: {
        cwd: '工具与终端操作的默认项目目录。',
      ...
      fileReadMaxChars: 'Verxio 单次文件读取可读取的最大字符数。',
      approvals: {
        mode: 'Verxio 如何处理需要显式审批的命令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Verxio 从应用内更新时（无终端提示），保留本地源码修改（暂存）或丢弃（放弃）。通过终端更新时始终会询问。'
      }
    }),
    about: {
      heading: 'Verxio',
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      whatsapp: '启动 Verxio 自带的 WhatsApp 桥接，首次运行时扫描二维码，然后启用该平台。',
      bluebubbles:
        '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 Verxio 指向该 URL。',
  ...
  profiles: {
    ...
    deleting: '删除中…',
    createDesc: '配置档案是相互独立的 Verxio 环境：各自拥有独立的配置、技能和 SOUL.md。',
    nameLabel: '名称',
  ...
  cron: {
    ...
    emptyDescNew: '按 cron 表达式排程一个提示词。Verxio 会运行它，并把结果发送到你选择的目的地。',
  ...
  composer: {
    ...
    placeholderStarting: '正在启动 Verxio…',
    placeholderReconnecting: '正在重新连接 Verxio…',
    ...
    attachUrlDesc: 'Verxio 将抓取该页面并作为本回合的上下文。',
  ...
  updates: {
    ...
    unsupportedMessage: '此版本的 Verxio 无法在应用内自行更新。',
    connectionRetry: '请检查网络连接后重试。',
    latestBody: '你正在运行最新版本。',
    allSetTitle: '已是最新',
    availableTitle: '有可用更新',
    availableBody: '新版 Verxio 已可安装。',
    updateNow: '立即更新',
    maybeLater: '稍后再说',
    moreChanges: count => `另有 ${count} 项更改。`,
    manualTitle: '从终端更新',
    manualBody: '你是从命令行安装的 Verxio，因此更新也需要在那里运行。请将此命令粘贴到终端：',
    manualPickedUp: '下次启动 Verxio 时会使用新版本。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody: 'Verxio 更新器会在自己的窗口中接管，并在完成后重新打开 Verxio。',
    applyingClose: 'Verxio 将关闭以应用更新。',
    errorTitle: '更新未完成',
  ...
  install: {
    ...
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 Verxio',
    finishingTitle: '正在收尾',
    failedDesc:
      '某个安装步骤失败。在 Windows 上，如果另一个 Verxio CLI 或桌面实例正在运行，可能会出现这种情况。请停止正在运行的 Verxio 实例后重试。可查看下面的详情或 desktop 日志中的完整记录。',
    activeDesc: '这是一次性设置。Verxio 安装器正在下载依赖并配置你的机器。之后启动会跳过此步骤。',
  ...
  onboarding: {
    headerTitle: '开始设置 Verxio',
    headerDesc: '连接模型提供方即可开始对话。大多数选项只需一次点击。',
    preparingInstall: 'Verxio 正在完成安装。首次运行通常不到一分钟。',
    starting: '正在启动 Verxio…',
    ...
    recommended: '推荐',
    connected: '已连接',
    featuredPitch: '一个订阅，300+ 前沿模型 — 运行 Verxio 的推荐方式',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自托管',
        description: '将 Verxio 指向本地或自托管的 OpenAI 兼容端点 (vLLM、llama.cpp、Ollama 等)。'
      }
    },
    backToSignIn: '返回登录',
    getKey: '获取密钥',
    ...
    flowSubtitles: {
      ...
      device_code: '在浏览器中打开验证页面 — Verxio 会自动连接',
      loopback: '打开浏览器登录 — Verxio 会自动连接',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付费 Verxio 订阅。',
    free: '免费',
    freeTier: '免费层',
  ...
  preview: {
    ...
    largeTitle: '此文件较大',
    largeBody: (label, size) => `${label} 大小为 ${size}。Verxio 只会显示前 512 KB。`,
    previewAnyway: '仍然预览',
    ...
    web: {
      ...
      failedToLoad: '预览加载失败',
      tryAgain: '重试',
      restarting: 'Verxio 正在重启...',
      askRestart: '让 Verxio 重启服务器',
      lookingRestart: taskId => `Verxio 正在查找要重启的预览服务器 (${taskId})`,
      restartingTitle: '正在重启预览服务器',
      restartingMessage: 'Verxio 正在后台工作。可在预览控制台查看进度。',
      ...
      finishedRestarting: message => `Verxio 已完成预览服务器重启${message ? `: ${message}` : ''}`,
      failedRestarting: message => `服务器重启失败：${message}`,
      unknownError: '未知错误',
      restartedTitle: '预览服务器已重启',
      reloadingNow: '正在重新加载预览。',
      restartFailedTitle: '预览重启失败',
      restartFailedMessage: 'Verxio 无法重启服务器。',
      stillWorking: 'Verxio 仍在工作，但还没有收到重启结果。服务器命令可能正在前台运行。',
  ...
  prompts: {
    ...
    sudoTitle: '管理员密码',
    sudoDesc: 'Verxio 需要你的 sudo 密码来运行特权命令。它只会发送给你的本地 agent。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重启 Verxio后可使用保存图片。',
    restartToSaveImages: '重启 Verxio以保存图片',
