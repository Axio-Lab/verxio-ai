...
export const en: Translations = {
  ...
  boot: {
    ready: 'Verxio is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Verxio settings',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Verxio backend is older than this desktop build and may not work correctly. Update to align them.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Verxio defaults?',
    ...
    socials: {
      title: 'Socials',
      intro:
        'Schedule and publish social posts with self-hosted Postiz. Connect multiple accounts, open the calendar, and let your agent draft and schedule content.',
      loading: 'Loading Socials…',
      failedLoad: 'Could not load Socials status.',
      ready: 'Ready',
      needsKey: 'Needs setup',
      disabled: 'Not enabled',
      unavailable: 'Unavailable',
      notConfigured: 'Postiz is not running on this Verxio deploy. Start the Postiz stack, then enable Socials.',
      setupTitle: 'Postiz for this workspace',
      enabledDescription: 'Social scheduling is enabled. Connect channels or open the calendar to manage posts.',
      disabledDescription: 'Enable Socials to provision a free Postiz workspace for scheduling.',
      enable: 'Enable Socials',
      disable: 'Disable',
      disableConfirm: 'Disable Socials for this workspace? Connected channels stay in Postiz until you remove them.',
      enableFailed: 'Could not enable Socials.',
      disableFailed: 'Could not disable Socials.',
      enabledTitle: 'Socials enabled',
      enabledMessage: 'Your workspace can schedule posts through Postiz.',
      disabledTitle: 'Socials disabled',
      disabledMessage: 'Postiz tools were removed from this agent runtime.',
      openCalendar: 'Open calendar',
      calendarTitle: 'Content calendar',
      calendarDescription:
        'Review and edit scheduled posts. If the calendar does not load here, open it in a new window.',
      calendarFailed: 'Could not open the calendar.',
      openInNewWindow: 'Open in new window',
      connectChannel: 'Connect channel',
      connectTitle: 'Connect a social account',
      connectDescription: 'Choose a network. You can connect multiple accounts; each opens Postiz OAuth.',
      connectFailed: 'Could not start channel connect.',
      connectOpenedTitle: 'Continue in Postiz',
      connectOpenedMessage: 'Finish connecting the account in the opened window, then return here.',
      channelsTitle: 'Connected channels',
      noChannelsTitle: 'No channels yet',
      noChannels: 'Connect LinkedIn, X, Instagram, and more. You can add several accounts.',
      disconnect: 'Disconnect',
      disconnectConfirm: 'Disconnect this channel from Postiz?',
      disconnectFailed: 'Could not disconnect channel.',
      disconnectedTitle: 'Channel disconnected',
      disconnectedMessage: 'The account was removed from this workspace calendar.',
      channelActive: 'Active',
      channelDisabled: 'Disabled',
      postsTitle: 'Upcoming posts',
      noPostsTitle: 'No scheduled posts',
      noPosts: 'Draft or schedule posts in the calendar, then they will appear here.',
      unscheduledPost: 'Unscheduled',
      draftPost: 'Draft'
    },
    runtime: {
      title: 'Runtime',
    ...
    config: {
      ...
      loading: 'Loading Verxio configuration...',
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Verxio workspaces: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Verxio will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Verxio...',
    placeholderReconnecting: 'Reconnecting to Verxio…',
    ...
    queueSend: 'Send',
    queueDelete: 'Delete',
    queueShowFull: 'Show full prompt',
    queueShowLess: 'Show less',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Verxio can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    allSetTitle: 'You’re all set',
    availableTitle: 'New update available',
    availableBody: 'A new version of Verxio is ready to install.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Verxio from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Verxio will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Verxio updater will take over in its own window and reopen Verxio when it’s done.',
    applyingClose: 'Verxio will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Verxio needs a one-time install',
    ...
    settingUpTitle: 'Setting up Verxio',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Verxio CLI or desktop instance is running. Stop any running Verxio instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Verxio installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Verxio",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Verxio is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Verxio…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Verxio at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Verxio connects automatically',
      loopback: 'Opens your browser to sign in — Verxio connects automatically',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Verxio subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Verxio will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Verxio is restarting...',
      askRestart: 'Ask Verxio to restart the server',
      lookingRestart: taskId => `Verxio is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Verxio is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Verxio finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Verxio could not restart the server.',
      stillWorking:
        'Verxio is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  prompts: {
    ...
    sudoDesc: 'Verxio needs your sudo password to run a privileged command. It is sent only to your local agent.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Verxio to use Save Image.',
    restartToSaveImages: 'Restart Verxio to save images',
