      ...
      {detail && (
        <details className="pl-[1.3125rem]">
          <summary className="cursor-pointer select-none text-muted-foreground/45 hover:text-muted-foreground/70">
            {t.assistant.thread.processNotificationOutput}
          </summary>
        ...
        >
          ...
          >
            <div
              ...
              autoFocus
              className={cn(
                'ui-prompt-input-editor__input max-h-48 min-h-0 w-full resize-none overflow-y-auto overscroll-y-contain whitespace-pre-wrap break-words [overflow-wrap:anywhere] bg-transparent p-0 pr-7 text-base leading-(--dt-line-height) text-foreground/95 outline-none sm:text-[length:var(--conversation-text-font-size)]',
