  ...
  it('prefers the host-visible image path', () => {
    expect(
      generatedImageFromResult({
        ...
        host_image: '/Users/me/verxio/cache/images/cat.png',
        image: '/Users/me/verxio/cache/images/cat.png',
        success: true
      })
    ).toBe('/Users/me/verxio/cache/images/cat.png')
  })
...
describe('stripGeneratedImageEchoes', () => {
  ...
  it('removes media links for generated local image path', () => {
