...
PROVIDER_SPECS: tuple[ProviderSpec, ...] = (
    ProviderSpec(
        ...
        key_envs=("GROQ_API_KEY", "STT_GROQ_API_KEY"),
    ...
    ProviderSpec(
        ...
        key_envs=("MISTRAL_API_KEY", "STT_MISTRAL_API_KEY"),
    ...
    ProviderSpec(
        ...
        key_envs=("ELEVENLABS_API_KEY", "STT_ELEVENLABS_API_KEY"),
    ...
    ProviderSpec(
        ...
        label="xAI",
        env_key="XAI_API_KEY",
        key_envs=("XAI_API_KEY", "STT_XAI_API_KEY"),
